...
class PublishManager {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (event.isWriteUpdateInfo && target != null && eventFile != null && !_this.cancellationToken.cancelled) {
                if (packager.platform !== (_index || _load_index()).Platform.WINDOWS || isSuitableWindowsTarget(target)) {
                    _this.taskManager.addTask((0, (_updateUnfoBuilder || _load_updateUnfoBuilder()).createUpdateInfoTasks)(event, publishConfigs).then(function (it) {
    ...
    awaitTasks() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield (0, (_updateUnfoBuilder || _load_updateUnfoBuilder()).writeUpdateInfoFiles)(updateInfoFileTasks, _this2.packager);
            yield _this2.taskManager.awaitTasks();
        })();
    }
}
